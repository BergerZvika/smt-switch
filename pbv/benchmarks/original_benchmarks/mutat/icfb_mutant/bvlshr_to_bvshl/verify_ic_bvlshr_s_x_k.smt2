...
(define-fun IC ((s (_ BitVec k)) (t (_ BitVec k)) (xlo (_ BitVec k)) (xhi (_ BitVec k))) Bool
 (let ((y (bvsub (clz t) (clz s)))) (and (bvule (clz s) (clz t)) (=> (distinct t zero) (= (bvlshr s y) t)) (=> (= t zero) (or (bvuge xhi y) (= s zero))) (=> (distinct t zero) (mcb xlo xhi y))))
)
