...
;(or  (bvsgt (bvshl s (int_to_pbv k 0)) t) (bvsgt (bvshl s (int_to_pbv k 1)) t) (bvsgt (bvshl s (int_to_pbv k 2)) t) (bvsgt (bvshl s (int_to_pbv k 3)) t) (bvsgt (bvshl s (int_to_pbv k 0)) t))
;)

(define-fun SC ((s Int) (t Int)) Bool (exists ((i (_ BitVec k))) (and (bvsge i  (int_to_pbv k 0)) (bvsle i (int_to_pbv k 0)) (bvsgt (bvshl s i) t))))
