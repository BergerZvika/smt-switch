...
;(or  (bvugt (bvshl s (int_to_pbv k 0)) t) (bvugt (bvshl s (int_to_pbv k 1)) t) (bvugt (bvshl s (int_to_pbv k 2)) t) (bvugt (bvshl s (int_to_pbv k 3)) t) (bvugt (bvshl s (int_to_pbv k 0)) t))
;)

(define-fun SC ((s Int) (t Int)) Bool (exists ((i (_ BitVec k))) (and (bvuge i  (int_to_pbv k 0)) (bvule i (int_to_pbv k 0)) (bvugt (bvshl s i) t))))
