...
;(or  (bvuge (bvshl s (int_to_pbv k 0)) t) (bvuge (bvshl s (int_to_pbv k 1)) t) (bvuge (bvshl s (int_to_pbv k 2)) t) (bvuge (bvshl s (int_to_pbv k 3)) t) (bvuge (bvshl s (int_to_pbv k 0)) t))
;)

(define-fun SC ((s Int) (t Int)) Bool (exists ((i (_ BitVec k))) (and (bvuge i  (int_to_pbv k 0)) (bvule i (int_to_pbv k 0)) (bvuge (bvshl s i) t))))
