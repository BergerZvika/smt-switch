...
;(or  (= (bvlshr s (int_to_pbv k 0)) t) (= (bvlshr s (int_to_pbv k 1)) t) (= (bvlshr s (int_to_pbv k 2)) t) (= (bvlshr s (int_to_pbv k 3)) t) (= (bvlshr s (int_to_pbv k k)) t))
;)

(define-fun SC ((s Int) (t Int)) Bool (exists ((i (_ BitVec k))) (and (bvuge i  (int_to_pbv k 0)) (bvule i (int_to_pbv k k)) (= (bvlshr s i) t))))
