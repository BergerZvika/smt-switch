...
(define-fun IC ((s (_ BitVec k)) (t (_ BitVec k)) (xlo (_ BitVec k)) (xhi (_ BitVec k))) Bool
 (and (=> (= (msb s) (_ bv0 1)) (let ((y (bvsub (clz t) (clz s)))) (and (bvule (clz s) (clz t)) (=> (distinct t zero) (= (bvlshr s y) t)) (=> (= t zero) (or (bvuge xhi y) (= s zero))) (=> (distinct t zero) (mcb xlo xhi y))))) (=> (= (msb s) (_ bv1 1)) (let ((y (bvsub (clz (bvnot t)) (clz (bvnot s))))) (and (bvule (clz (bvnot s)) (clz (bvnot t))) (=> (distinct (bvnot t) zero) (= (bvlshr (bvnot s) y) (bvnot t))) (=> (= (bvnot t) zero) (or (bvuge xhi y) (= (bvnot s) zero))) (=> (distinct (bvnot t) zero) (mcb xlo xhi y))))))
)
