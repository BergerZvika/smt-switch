...
(define-fun IC ((s (_ BitVec k)) (tx (_ BitVec k)) (tn (_ BitVec 4)) (xlo (_ BitVec k)) (xhi (_ BitVec k))) Bool
 (and
  (or
   (and (= tn (int_to_pbv 4 0)) (= (pextract (- k 1) (- k 1)  tx) (int_to_pbv 1 0)))
   (and (= tn (bvnot (int_to_pbv 4 0))) (= (pextract (- k 1) (- k 1)  tx) (int_to_pbv 1 1)))
  )
  (mcb xlo xhi tx)
 )
)
