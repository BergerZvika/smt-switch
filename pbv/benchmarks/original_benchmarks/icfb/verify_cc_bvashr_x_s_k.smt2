...
(define-fun CC ((t (_ BitVec k)) (xlo (_ BitVec k)) (xhi (_ BitVec k))) Bool
 (and (=> (or (= t zero) (= t ones)) (exists ((i (_ BitVec k))) (and (= (msb i) (msb t)) (mcb xlo xhi i)))) (=> (and (distinct t zero) (distinct t ones)) (exists ((i (_ BitVec k))) (and (bvule i (ite (= (msb (bvshl t i)) (_ bv1 1)) (clo t) (clz t))) (mcb (bvashr xlo i) (bvashr xhi i) t)))))
)
