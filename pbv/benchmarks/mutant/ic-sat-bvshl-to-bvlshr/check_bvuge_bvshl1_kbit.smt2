...
;(or  (bvuge (bvlshr s (_ bv0 k)) t) (bvuge (bvshl s (_ bv1 k)) t) (bvuge (bvshl s (_ bv2 k)) t) (bvuge (bvshl s (_ bv3 k)) t) (bvuge (bvshl s (_ bvk k)) t))
;)

(define-fun SC ((s Int) (t Int)) Bool (exists ((i (_ BitVec k))) (and (bvuge i  (_ bv0 k)) (bvule i (_ bvk k)) (bvuge (bvshl s i) t))))
