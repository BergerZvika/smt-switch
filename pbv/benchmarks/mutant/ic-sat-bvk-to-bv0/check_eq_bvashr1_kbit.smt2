...
;(or  (= (bvashr s (_ bv0 k)) t) (= (bvashr s (_ bv1 k)) t) (= (bvashr s (_ bv2 k)) t) (= (bvashr s (_ bv3 k)) t) (= (bvashr s (_ bv0 k)) t))
;)

(define-fun SC ((s Int) (t Int)) Bool (exists ((i (_ BitVec k))) (and (bvuge i  (_ bv0 k)) (bvule i (_ bvk k)) (= (bvashr s i) t))))
