...
;(or  (bvugt (bvlshr s (int_to_pbv k 0)) t) (bvugt (bvshl s (int_to_pbv k 1)) t) (bvugt (bvshl s (int_to_pbv k 2)) t) (bvugt (bvshl s (int_to_pbv k 3)) t) (bvugt (bvshl s (int_to_pbv k k)) t))
;)
