...
;(or  (bvugt (bvlshr s (_ bv0 k)) t) (bvugt (bvshl s (_ bv1 k)) t) (bvugt (bvshl s (_ bv2 k)) t) (bvugt (bvshl s (_ bv3 k)) t) (bvugt (bvshl s (_ bvk k)) t))
;)

(define-fun SC ((s Int) (t Int)) Bool (exists ((i (_ BitVec k))) (and (bvuge i  (_ bv0 k)) (bvule i (_ bvk k)) (bvugt (bvshl s i) t))))
