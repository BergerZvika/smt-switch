...
;(or  (bvuge (bvlshr s (int_to_pbv k 0)) t) (bvuge (bvshl s (int_to_pbv k 1)) t) (bvuge (bvshl s (int_to_pbv k 2)) t) (bvuge (bvshl s (int_to_pbv k 3)) t) (bvuge (bvshl s (int_to_pbv k k)) t))
;)
