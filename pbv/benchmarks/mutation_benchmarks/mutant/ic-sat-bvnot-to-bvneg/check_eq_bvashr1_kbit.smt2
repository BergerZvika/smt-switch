...
;(or  (= (bvashr s (int_to_pbv k 0)) t) (= (bvashr s (int_to_pbv k 1)) t) (= (bvashr s (int_to_pbv k 2)) t) (= (bvashr s (int_to_pbv k 3)) t) (= (bvashr s (int_to_pbv k k)) t))
;)

(define-fun SC ((s Int) (t Int)) Bool (exists ((i (_ BitVec k))) (and (bvuge i  (int_to_pbv k 0)) (bvule i (int_to_pbv k k)) (= (bvashr s i) t))))

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec k))) (= (bvashr s x) t)))
  (=> (exists ((x (_ BitVec k))) (= (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
